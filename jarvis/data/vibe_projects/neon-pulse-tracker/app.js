...
const prompts = ["Design a polished web app called Neon Pulse Tracker \u2014 habit streaks with a cyber HUD.", "Hero section with bold typography, cyan accent, dark void background.", "Interactive UI with localStorage, keyboard shortcuts, empty states.", "Mobile-first layout, one primary CTA, gallery of mood images."];
