...
const prompts = ["Design a polished web app called Hydration Ping \u2014 water intake tracker with reminders log.", "Hero section with bold typography, cyan accent, dark void background.", "Interactive UI with localStorage, keyboard shortcuts, empty states.", "Mobile-first layout, one primary CTA, gallery of mood images."];
