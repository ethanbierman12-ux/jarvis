...
const prompts = ["Design a polished web app called Checklist Arena \u2014 shared-style checklists with progress bars.", "Hero section with bold typography, cyan accent, dark void background.", "Interactive UI with localStorage, keyboard shortcuts, empty states.", "Mobile-first layout, one primary CTA, gallery of mood images.", "InSoft Inc. was an American developer of network-based communications software and multimedia softwa"];
